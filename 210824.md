...
* 농림수산식품교육문화정보원_농수축산물 품목별 상세조사가격 서비스
...
* 농림수산식품교육문화정보원_팜맵기반 농업기상 조회 서비스
  ...
  - 기온, 습도, 토양수분값, 결로시간, 일사량, 일조시간, 적설량, 강수량, 풍속 등
  - https://www.data.go.kr/data/15058627/openapi.do
...
* VDS 설치정보 조회 서비스
  ...
  * vdsId, grs80x, grs80y, routeNo, routeName, directionCode, czId
  * vds 총 개수 : 7730~7740개
...
* 머신러닝기법을 활용한 한정판 운동화 리셀 여부 예측 및 수익성 평가
